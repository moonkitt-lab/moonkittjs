...
export const ExtensionData = {
  typeUrl: "/gaia.metaprotocols.ExtensionData",
  is(o: any): o is ExtensionData {
    return o && (o.$typeUrl === ExtensionData.typeUrl || typeof o.protocolId === "string" && typeof o.protocolVersion === "string" && (o.data instanceof Uint8Array || typeof o.data === "string"));
  },
  isSDK(o: any): o is ExtensionDataSDKType {
    return o && (o.$typeUrl === ExtensionData.typeUrl || typeof o.protocol_id === "string" && typeof o.protocol_version === "string" && (o.data instanceof Uint8Array || typeof o.data === "string"));
  },
  isAmino(o: any): o is ExtensionDataAmino {
    return o && (o.$typeUrl === ExtensionData.typeUrl || typeof o.protocol_id === "string" && typeof o.protocol_version === "string" && (o.data instanceof Uint8Array || typeof o.data === "string"));
  },
...
GlobalDecoderRegistry.register(ExtensionData.typeUrl, ExtensionData);