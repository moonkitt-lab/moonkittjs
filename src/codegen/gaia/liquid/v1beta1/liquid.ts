...
export const Params = {
  typeUrl: "/gaia.liquid.v1beta1.Params",
  aminoType: "gaia/x/liquid/Params",
  is(o: any): o is Params {
    return o && (o.$typeUrl === Params.typeUrl || typeof o.globalLiquidStakingCap === "string" && typeof o.validatorLiquidStakingCap === "string");
  },
  isSDK(o: any): o is ParamsSDKType {
    return o && (o.$typeUrl === Params.typeUrl || typeof o.global_liquid_staking_cap === "string" && typeof o.validator_liquid_staking_cap === "string");
  },
...
export const LiquidValidator = {
  typeUrl: "/gaia.liquid.v1beta1.LiquidValidator",
  is(o: any): o is LiquidValidator {
    return o && (o.$typeUrl === LiquidValidator.typeUrl || typeof o.operatorAddress === "string" && typeof o.liquidShares === "string");
  },
  isSDK(o: any): o is LiquidValidatorSDKType {
    return o && (o.$typeUrl === LiquidValidator.typeUrl || typeof o.operator_address === "string" && typeof o.liquid_shares === "string");
  },
  isAmino(o: any): o is LiquidValidatorAmino {
    return o && (o.$typeUrl === LiquidValidator.typeUrl || typeof o.operator_address === "string" && typeof o.liquid_shares === "string");
  },
...
GlobalDecoderRegistry.register(LiquidValidator.typeUrl, LiquidValidator);